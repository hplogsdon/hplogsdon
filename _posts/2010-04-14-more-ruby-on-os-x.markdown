...
He suggested I try RVM. [Ruby Version Manager](http://rvm.beginrescueend.com/) is a simple little script that will download, configure, make and install specific versions, as well as patchlevels of the Ruby language into your $HOME directory.
