...
Part 1: <a href="http://hplogsdon.com/configuring-a-headless-freebsd-server/">Configuring a headless FreeBSD server.</a>
Part 2: <a href="http://hplogsdon.com/configuring-the-famp-stack/">Configuring the FAMP Stack</a>
Part 3: <a href="http://hplogsdon.com/installing-ruby-rubygems-and-rails/">Installing Ruby, RubyGems, and Rails</a>
Part 4: <a href="http://hplogsdon.com/configuring-mongrel-and-mongrel-cluster/">Configuring Mongrel and Mongrel Cluster</a>
