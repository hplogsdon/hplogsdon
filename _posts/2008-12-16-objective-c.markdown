...
- Objective-C
- Source Code
wordpress_url: http://166.70.27.129/dev/hplogsdon/blog/?p=41
published: true
layout: post
wordpress_id: 41
categories: 
...
Well come to find out that Objective-C is nothing more than an Objective framework on top of C. Makes my life easier. So I've been plowing though Kochan's Programming in Objective-C book. Its a really nice transition from C to Obj-C. I can fall back and do a purely Functional based program without feeling like too much of a pussy for using <code>printf("\n");</code> instead of <code>std::cout << "\n"; </code>
