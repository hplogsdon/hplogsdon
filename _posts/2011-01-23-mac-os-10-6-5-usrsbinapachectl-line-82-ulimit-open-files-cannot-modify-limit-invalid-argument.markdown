...
or check out this article [The Ten Minute Guide to diff and patch](http://stephenjungels.com/jungels.net/articles/diff-patch-ten-minutes.html) which I'll admit to referring to every once in a while when I need to create a patch by hand.
