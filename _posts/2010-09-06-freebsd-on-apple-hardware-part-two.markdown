...
Add a FreeBSD Boot partition to contain the bootcode. '-s' specifies the size of the partition in 512 byte blocks.<pre>
# gpart add -t freebsd-boot -s 128 ad4
</pre>

Add a FreeBSD Swap partition double the size of your physical RAM.<pre>
# gpart add -t freebsd-swap -s 8388608 ad4
</pre>

And then add your standard filesystems, sized for whatever you need. I used 1Gb for /var and / (root), and 20GB for /usr. I used the leftover space for /home.<pre>
...
Those partitions aren't formatted, so newfs them. <pre>
# newfs ad4p5
# newfs -U ad4p6
# newfs -U ad4p7
# newfs -U ad4p8</pre>
...
Lets mount our new filesystems first.<pre>
# mount /dev/ad0p5 /mnt
# cd /mnt
