...
If Ruby hangs at ```Generating RI...``` then let it sit for a few minutes. Maybe up to a half hour. Or several hours. It will finally complete, and then we can continue on. 
...
If you don't have any continuing issues, proceed to Part 4: [Configuring Mongrel and Mongrel Cluster](/configuring-mongrel-and-mongrel-cluster/)
