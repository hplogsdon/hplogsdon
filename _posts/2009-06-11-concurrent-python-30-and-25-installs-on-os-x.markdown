...
wordpress_url: http://dharmahacker.com/blog/?p=114
published: true
layout: post
wordpress_id: 114
categories: 
...
excerpt: |
  ...
  So I took about 3 seconds and a google search of "update python os x", and came across <a href="http://farmdev.com/thoughts/66/python-3-0-on-mac-os-x-alongside-2-6-2-5-etc-/">Python 3.0 On Mac OS X (alongside 2.6, 2.5, etc)</a>.

author_login: uxp
author_email: uxp@bsdeviant.org
title: Concurrent Python 3.0 and 2.5 Installs on OS X
comments: []

author_url: http://hplogsdon.com
status: publish
date: 2009-06-11 18:03:17 -06:00
author: uxp
---
Ran into an issue while needing Python 3.0.1, and OS X's Python install is only 2.5.1 on Leopard.
