...
- Software
- Source Code
excerpt: "The past few posts have been a \"I use this, but I extended its default\xC2\xA0functionality with this:\" posts...\xC2\xA0Well this one is no different. I have slowly become fed up with Safari. Every update seems to make it run slower. I've noticed as the day wears on, it can take up to 30 seconds to load a new tab. WTF is that shit. "
author_login: uxp
...
<a href="http://blog.hplogsdon.com/files/chromium-nightly.tar.gz">chrome-nightly.sh</a>

Set it up into cron, or make a launch controller for it:

[sourcecode lanugage="xml"]
