...
description: I'm changing things again. I know that no one is reading this. I get occasional searches for SilverStripe theme help, bot overall it's dead.
author_url: http://hplogsdon.com
status: publish
date: 2008-11-24 15:05:39 -07:00
author: uxp
---
Changing again. I know that no one is reading this. I get occasional searches for SilverStripe theme help. The first time i assembled the site was through [SilverStripe](http://www.silverstripe.com) and had issues with the way SS laid out the structure of the site. They did some weird things which wasn't all that different from the file system structure of a 'nix box. But, I didn't think it translated well to a web environment.
