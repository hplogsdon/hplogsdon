...
excerpt: |
  ...
  If you drop down into Terminal.app and look at the ruby executable
...
Note: this installation will only install your default architecture (i386 fro CoreDuo, x86_64 for C2D, ppc for PowerPC, etc). You'll have to throw the environmental variables into your config line to get fat binaries up.
